...
local spidertron_builder_laser = {
    ...
    type = "gun",
    subgroup = "gun",
    icon = "__spidertron-extended-se__/graphics/spidertron_builder_laser_turret_1.png",
    icon_size = 64,
    stack_size = 5,
...
local spidertron_builder_laser2 = {
    ...
    type = "gun",
    subgroup = "gun",
    icon = "__spidertron-extended-se__/graphics/spidertron_builder_laser_turret_2.png",
    icon_size = 64,
    stack_size = 5,
    attack_parameters = {
        type = "beam",
...
local immolator_flamethrower = {
    ...
    type = "gun",
    subgroup = "gun",
    icon = "__spidertron-extended-se__/graphics/spidertron_immolator_gun_icon_2.png",
    icon_size = 64,
    stack_size = 5,
